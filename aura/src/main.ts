...
const routes: Routes = [
  ...
  {
    path: 'premium/iot/overview/building',
  ...
  {
    path: 'premium/iot/overview/building/create',
    component: BuildingsCreateComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/index/:id',
    component: BuildingIndexComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/update',
    component: BuildingUpdateComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/branch/:id',
    component: BuildingBranchComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/branch/:id/create',
    component: BuildingBranchCreateComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName',
    component: BuildingBranchIndexComponent,
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/create/devices',
    component: DeviceComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/:deviceName',
    component: DetailsDeviceComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/:deviceName/:idActuador/conditions/create',
    component: CreateConditionComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/:deviceName/conditions/edit',
    component: EditConditionComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  }, {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/:deviceName/:idActuador/overview/conditions',
    component: OverviewConditionsComponent,
    canActivate: [AuthGuard],
    data: { authorities: ['super_usuario'] },
  },
  {
    path: 'premium/iot/overview/building/:buildingName/level/:id/branch/:branchName/:deviceName/:idActuador/overview/conditions/view',
